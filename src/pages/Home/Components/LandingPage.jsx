  ...
  const templates = [
    {
      ...
      image:
        "C:/Users/Admin/AI-Resume-Builder/frontend/public/templates/chronological.png",
    },
    {
      name: "Functional",
      desc: "Skills-based layout",
      image:
        "C:/Users/Admin/AI-Resume-Builder/frontend/public/templates/functional.png",
    },
    {
      name: "Creative",
      desc: "Bold and unique design",
      image:
        "C:/Users/Admin/AI-Resume-Builder/frontend/public/templates/creative.png",
    },
    {
      name: "Modern",
      desc: "Contemporary professional",
      image:
        "C:/Users/Admin/AI-Resume-Builder/frontend/public/templates/modern.png",
    },
    {
      name: "Minimalist",
      desc: "Clean and simple",
      image:
        "C:/Users/Admin/AI-Resume-Builder/frontend/public/templates/minimalist.png",
    },
    {
      name: "Executive",
      desc: "Senior-level format",
      image:
        "C:/Users/Admin/AI-Resume-Builder/frontend/public/templates/executive.png",
    },
  ];
  ...
  const howItWorksSteps = [
    {
      ...
      description:
        "Start building your resume effortlessly by choosing from our professionally designed templates suited for various career paths and experience levels. If you already have a resume, you can upload it and refine it with improved structure, formatting, and content suggestions to make it more professional and impactful.",
    },
    {
      ...
      description:
        "Get real-time ATS score insights while creating your resume, helping you understand how well it matches recruiter expectations and system requirements. You can also upload an existing resume to instantly analyze its structure, keywords, and formatting, allowing you to identify gaps and improve its ATS compatibility for better visibility and higher chances of getting shortlisted.",
    },
    {
      ...
      description:
        "Simply enter your experience details, and our AI will intelligently craft well-structured, impactful bullet points that highlight your key skills, accomplishments, and responsibilities. This helps present your experience in a clear, professional manner while ensuring your resume remains concise, relevant, and optimized for both recruiters and ATS systems.",
    },
    {
      icon: "fa-magic",
      title: "OPTIMIZER",
      ...
      description:
        "Effortlessly tailor and optimize your resume for any job listing with a single click. Get instant, role-specific improvements that enhance relevance, highlight key skills, and increase your chances of standing out to recruiters and ATS systems.",
    },
    {
      icon: "fa-download",
      ...
      description:
        "Download your polished, job-ready resume in your preferred format, or create multiple tailored versions designed for different roles, industries, or companies. This flexibility allows you to customize your resume for each application, improving relevance and increasing your chances of success.",
    },
  ];
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#0a1628] via-[#0f1f3d] to-[#1a2e52] text-white">
        ...
        <div className="max-w-[1400px] mx-auto px-8 flex items-center justify-between gap-8">
          ...
          <div className="flex flex-col gap-1 cursor-pointer">
            <div className="text-2xl font-extrabold tracking-wide font-['Space_Grotesk']">
              <img src={UpToSkillsImg} alt="UpToSkills Logo" width={150} />
            </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <button
              className="flex items-center gap-2 px-6 py-3 border border-[#00d9ff] text-[#00d9ff] rounded-lg font-semibold transition-all duration-300 hover:bg-[#00d9ff]/10"
            ...
            <button
              className="flex items-center gap-2 px-6 py-3 bg-[#ff6b3d] text-white rounded-lg font-semibold transition-all duration-300 hover:bg-[#ff5722] hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(255,107,61,0.4)]"
      ...
      <section className="relative px-8 pt-16 pb-8 min-h-[calc(100vh-100px)] flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-8 pt-8 order-2 lg:order-1">
            ...
            <h2 className="text-3xl font-bold text-[#00d9ff]">
              AI Resume Builder
            </h2>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-10 py-5 text-lg font-bold text-[#00d9ff] border-2 border-[#00d9ff] rounded-xl transition-all duration-300 hover:bg-[#00d9ff]/10 hover:-translate-y-1"
              >
          ...
          <div className="flex flex-col gap-8 order-1 lg:order-2">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 overflow-hidden">
              <div className="flex justify-between items-center mb-6 pb-4 border-b border-white/10">
                <span className="text-sm font-extrabold text-[#ff6b3d] tracking-widest">
                  UPTOSKILLS
                </span>
      ...
      <section className="py-20 px-8">
        <div className="max-w-[1400px] mx-auto">
          <h2 className="text-5xl font-extrabold text-center mb-4 text-[var(--text-white)]">
            How{" "}
            <span className="bg-gradient-to-br from-[#ff6b3d] to-[#00d9ff] bg-clip-text text-transparent">
              It works
            </span>
          </h2>
          <p className="text-center text-[1.1rem] text-[var(--text-gray)] mb-16 max-w-[800px] mx-auto">
          ...
          <div>
            {howItWorksSteps.map((step, index) => (
              <div
                key={index}
                className={`flex items-center gap-8 p-4 mb-[15px] rounded-[20px] bg-transparent border-0 transition-all duration-[600ms] ease-in-out cursor-default md:grid-cols-2 grid-cols-1
                          ${
                            index % 2 === 0
              ...
              >
                <div className="w-[30rem] h-[20rem] bg-black rounded-xl"></div>
                <div>
                  <div className="text-[#00d9ff] flex items-center gap-4 mb-5 select-none">
                    <div className="inline-flex items-center gap-3 bg-[rgba(0,217,255,0.1)] px-6 py-3 rounded-[50px] w-fit border border-[rgba(0,217,255,0.2)]">
                      <i className={`fas ${step.icon} text-[1.2rem]`}></i>
                      <h3 className="text-[0.8rem] font-bold leading-[1.3] sm:text-[1.2rem]">
                        {step.heading}
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="ml-5 flex flex-col">
                    <div className="max-w-2xl text-xl font-space">{step.description}</div>
                  </div>
                </div>
              </div>
            ))}
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="w-15 h-15 bg-gradient-to-br from-[#00d9ff]/20 to-[#4c7fff]/20 rounded-xl flex items-center justify-center mb-6">
                  <i
                    className={`fas ${feature.icon} text-3xl text-[#00d9ff]`}
                  ></i>
                </div>
